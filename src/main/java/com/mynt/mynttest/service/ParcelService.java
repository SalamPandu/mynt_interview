...
import com.mynt.mynttest.exception.ApiRejectException;
import com.mynt.mynttest.repository.ParcelRepository;
...
public class ParcelService {
    ...
    @Autowired
    public ParcelService(ParcelRepository repo, RuleService ruleService, VoucherService voucherService) {
        this.repo = repo;
    ...
    public Parcel create(Parcel parcel) {
        ...
        applyVoucher(parcel);
        if(parcel.getCost() == 0){
            throw new ApiRejectException("Parcel cost computation Rejected due to rule vilation.");
        }
